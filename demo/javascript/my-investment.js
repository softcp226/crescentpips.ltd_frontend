...
let handle_cancel_investment = async (button, investment) => {
  try {
    ...
    window.location.href = "/demo/my-investment.html";
  } catch (err) {
    alert(err.message);
    button.innerHTML = "try again";
  }
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://crescentpips-backend.glitch.me/api/user/demo/investments/fetch",
      // "http://localhost:5000/api/user/demo/investments/fetch",
